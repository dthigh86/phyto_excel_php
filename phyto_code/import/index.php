...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	try {
		...
		if ( move_uploaded_file($_FILES['file']['tmp_name'], $target_path) ) {
			...
			foreach ($sheetData as $index => $row) {
				...
				$sql = "INSERT INTO phyto_pest_info
						(`pest_id`, `img_url`, `com_name`, `sci_name`, `acrynom`, `type`, `other_names`, `dist`, `us_dist`, `countries`, `other`, `host_range`)
		...
		//echo "upload_success";
        // Back to Import page with success msg..
        ?>
                <script language="javascript" type="text/javascript">
                    window.location = "/import.php?msg=success";
                </script>
                <?php // done. 
